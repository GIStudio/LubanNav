...
语音模板内置两条主动提醒：**会话开场**先按实时天气提醒一句“出门带伞”（降雨/高降水概率时明确提醒带伞防滑，晴热提醒防晒补水）；**接近或到达目的地**时（如用户说“快到了”“还有多远”“到了”）像公交到站提示一样提醒“请带好随身物品”（背包、手机、校园卡等）。
