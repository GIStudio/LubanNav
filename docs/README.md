...
| [robot-ble-protocol.md](robot-ble-protocol.md) | Web Bluetooth 机器人协议 v1：GATT 合约、JSON Lines 分包、消息格式、安全边界 | 固件开发者 |
...
- **想接入机器人**：按 [robot-ble-protocol.md](robot-ble-protocol.md) 实现固件消息，无真机时用 [ble-simulator.md](ble-simulator.md) 联调，验收流程见 [car7-local-ble-test.md](car7-local-ble-test.md)。
