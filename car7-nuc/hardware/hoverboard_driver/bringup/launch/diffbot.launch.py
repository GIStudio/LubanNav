...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument(
            "imu_enabled",
            default_value="false",
            description="Publish hoverboard IMU frames if firmware sends 0xACDC IMU packets.",
        ),
    ]
    ...
    # Humble treats Command() output as YAML unless forced to str; URDF must stay a string.
    robot_description = {
